window.ACADEMIC_SKILLS_RANKINGS = {
  "metadata": {
    "generated_at": "2026-09-25T07:50:42Z",
    "min_stars": 100,
    "total": 52,
  ...
  "items": [
    ...
    },
    {
      ...
      "description": "🌊深度整合全球顶尖学术、金融与教育资源：学术板块汇聚 JSTOR、Taylor & Francis、剑桥大学出版社等权威平台的论文，并接入 Z-Library 影子图书馆的海量电子书；教育板块收录香港、新加坡从小学到高中以及大学学科教科书；金融板块则聚合香橼、摩根、野村等顶级机构的深度研报，只为打破信息孤岛，构建知识平权普惠知识库。",
      ...
      "last_push_date": "2026-09-21",
      "url": "https://github.com/hoochanlon/hamuleite",
      "homepage": "",
      "agents": [],
      "precision_signals": [
        "academic",
    ...
    },
    {
      ...
      "description": "一套为研究生和学术研究者设计的完整AI Prompt库  📖 包含内容： ✨ 40+ 精心设计的AI Prompt ✨ 论文选题系统方法（生成、评估、论证） ✨ 论文查找快速方案（8个不同方案） ✨ 文献综述框架和工具 ✨ Excel自动评估表格 ✨ 3个完整的论证模板  🚀 核心优势： ⚡ 节省时间 50-70%（选题3-5天而不是2-3周） 🎯 科学方法（基于系统的5维度评估体系） 💡 即插即用（所有Prompt直接复制可用） 📚 全流程覆盖（从选题到出版的完整方案）  🎓 适用人群： 👨‍🎓 硕士研究生 | 博士研究生 | 本科毕业设计 | 学术研究者 | 内容创作者  ",
      "language": "",
      "topics": [
        "academic-research",
        "ai",
    ...
    },
    {
      ...
      "homepage": "https://mms.weseeworld.cn",
      "agents": [
        "claude-code",
        "codex"
      ],
    ...
    },
    {
      ...
      "homepage": "https://starterkit.getdesign.md/",
      "agents": [],
      "precision_signals": [
        "paper",
        "papers",
    ...
    },
    {
      ...
      "description": "A ready-to-fork Claude Code template for academics using LaTeX/Beamer + R. Multi-agent review, quality gates, adversarial QA, and replication protocols.",
      "language": "HTML",
      "topics": [
        "academic-writing",
        "causal-inference",
    ...
    },
    {
      ...
      "description": "Systematic framework for planning and writing academic papers using Claude Code. Includes strategist (planning) and composer (writing) skills with quality checkpoints.",
      "language": "Python",
      "topics": [
        "academic-writing",
        "claude-code",
    ...
    },
    {
      ...
      "description": "Enterprise-grade deep research skill for Claude Code with 8-phase pipeline, source credibility scoring, and automated validation. Outperforms OpenAI, Gemini, and Claude Desktop in quality and verification.",
      "language": "Python",
      "topics": [],
    ...
    },
    {
      ...
      "description": "A Claude Code plugin that turns your terminal into an autonomous research lab — literature survey, experiment execution, paper writing, all in one pipeline.",
      "language": "TypeScript",
      "topics": [],
      "created_date": "2026-03-10",
    ...
    },
    {
      ...
      "description": "Agent Skill that transforms AI assistants into expert economics paper writers. Synthesizes 50+ guides by Cochrane, McCloskey, Shapiro, Head, Bellemare, Goldin, Kremer. Compatible with Claude Code and OpenAI Codex.",
      "language": "Python",
      "topics": [
        "academic-writing",
        "agent-skills",
    ...
    },
    {
      ...
      "description": "Agent skills for drafting, revising, auditing, and resubmitting Nature-style journal manuscripts.",
      "language": "Python",
      "topics": [],
    ...
    },
    {
      ...
      "description": "A collection of Claude Code skills for academic research review. These tools were developed by Claes Bäckman.",
      "language": "",
      "topics": [],
      "created_date": "2026-03-01",
      "last_push_date": "2026-08-27",
    ...
    {
      "rank": 44,
      "repo": "congcongwang0122/zotero-skill",
      "stars": 199,
      "star_delta_1d": 0,
      "star_delta_7d": 6,
      "star_delta_30d": 36,
      ...
      "description": "「帮我整理总结一下 Zotero 中 XXX 栏所有的文献，并生成一个一万字的综述」**—— 这句话，现在真的可以被实现了。",
      "language": "Python",
      "topics": [],
      "created_date": "2026-06-03",
      "last_push_date": "2026-08-14",
      "url": "https://github.com/congcongwang0122/zotero-skill",
      "homepage": "",
      "agents": [],
      "precision_signals": [
        "skill",
    ...
    {
      "rank": 45,
      "repo": "brycewang-stanford/Auto-Research-Skills",
      "stars": 174,
      "star_delta_1d": 4,
      "star_delta_7d": 10,
      "star_delta_30d": 34,
      ...
      "last_push_date": "2026-09-21",
      "url": "https://github.com/brycewang-stanford/Auto-Research-Skills",
      "homepage": "",
      "agents": [
        "claude-code"
      ],
    ...
    {
      "rank": 46,
      "repo": "stephenlzc/AI-Powered-Literature-Review-Skills",
      "stars": 155,
      "star_delta_1d": 2,
      "star_delta_7d": 6,
      "star_delta_30d": 26,
      ...
      "description": "AI驱动的系统性学术文献回顾工具 | AI-Powered Literature Survey Tool with 8-Phase Workflow & Agent Swarm Architecture",
      "language": "Python",
      "topics": [
        "academic-papers",
        "academic-research",
    ...
    },
    {
      ...
      "description": "📄 论文全流程辅助 AI Skill — 检索 2 亿+论文、文献综述生成、写作润色、查重预检、降 AI 率改写、参考文献管理，4 源免费即用",
      "language": "Python",
      "topics": [],
      "created_date": "2026-04-07",
      "last_push_date": "2026-04-07",
      "url": "https://github.com/Jesseovo/PaperCash",
      "homepage": "",
      "agents": [],
      "precision_signals": [
        "paper",
    ...
    {
      "rank": 49,
      "repo": "Drchronx/ai-agent-research-starter-kit",
      "stars": 113,
      "star_delta_1d": 3,
      "star_delta_7d": 3,
      "star_delta_30d": 3,
      ...
      "description": "AI Agent 科研全流程教学包，能教学生从零部署 Codex、Claude Code、OpenClaw、Hermes 等 Agent，学会使用 Skills、飞书、AMiner、AI4Scholar、Zotero、Obsidian 等工具，完成真实文献检索、文献日报、知识库搭建、选题生成、理论建构、情景实验设计、量表开发、统计分析、因果推断、文本挖掘、EEG/ERP 实验、BCI 脑电智能建模、论文写作、审稿自查、期刊排版和盲审投稿包制作；学生学完后可以按课程模板一步步让 AI Agent 协助完成从“找文献、定选题、做实验、分析数据”到“写论文、查引用、改格式、准备投稿”的完整科研流程。",
      "language": "Python",
      "topics": [],
      "created_date": "2026-05-19",
      "last_push_date": "2026-05-19",
      "url": "https://github.com/Drchronx/ai-agent-research-starter-kit",
      "homepage": "",
      "agents": [
        "claude-code",
        "codex"
    ...
    {
      "rank": 50,
      "repo": "kael-odin/awesome-academic-research-skills",
      "stars": 108,
      "star_delta_1d": 1,
      "star_delta_7d": 1,
      "star_delta_30d": 1,
      ...
      "description": "面向中文用户的学术论文与科研 Agent Skill 每日排行榜 · 自动搜索、过滤并排名 GitHub 上的 Claude Code / Codex / OpenCode 科研 Skill 仓库",
      "language": "JavaScript",
      "topics": [
        "academic-research",
        "academic-writing",
      ...
      "homepage": "https://kael-odin.github.io/awesome-academic-research-skills/",
      "agents": [
        "claude-code",
        "codex",
        "opencode",
    ...
    },
    {
      ...
      "description": "Evidence-first AI workflow for economic and financial research: literature → identification → data → econometrics → verifiable LaTeX. 43 data sources, 58 method modules, 18 AI skills, 30 journal templates.",
      "language": "Python",
      "topics": [
        "academic-research",
        "ai-agents",
      ...
      "homepage": "https://csmar432.github.io/finai-research/",
      "agents": [
        "mcp"
      ],
      "precision_signals": [
    ...
    {
      "rank": 52,
      "repo": "wycmochi/cn-academic-spark",
      "stars": 104,
      "star_delta_1d": 0,
      "star_delta_7d": 0,
      "star_delta_30d": 0,
      ...
      "description": "专为中国宝宝设计的可编辑学术 PPT 生成skill。可根据学术汇报场景（论文答辩、组会汇报、课程报告、开题报告、文献综述等），依据上传的论文、报告等材料分析研究框架并输出带讲稿、带技术路线图、可编辑的pptx文件。",
      "language": "Python",
      "topics": [],
      "created_date": "2026-05-12",
      "last_push_date": "2026-08-28",
      "url": "https://github.com/wycmochi/cn-academic-spark",
      "homepage": "",
      "agents": [],
      "precision_signals": [
        "academic",
